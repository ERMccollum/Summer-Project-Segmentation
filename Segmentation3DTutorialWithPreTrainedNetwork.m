...
% 
% layername  = 'concat1'     
% concat1Features = activations(net,vol{volId},layername );
% concat1nii = make_nii(concat1Features,[],[],[],'concatenation');
% save_nii(concat1nii,'concat1.nii' ) ;
% 
% layername  = 'concat2'     
% concat2Features = activations(net,vol{volId},layername );
% concat2nii = make_nii(concat2Features,[],[],[],'concatenation');
% save_nii(concat2nii,'concat2.nii' ) ;
% 
% layername  = 'concat3'     
% concat3Features = activations(net,vol{volId},layername );
% concat3nii = make_nii(concat3Features,[],[],[],'concatenation');
% save_nii(concat3nii,'concat3.nii' ) ;
...
% expand_nii_scan('convolution.nii',[],[/home/igilab/Documents/)
% 
